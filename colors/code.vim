...
hi Normal ctermfg=231 ctermbg=237 cterm=NONE guifg=#f8f8f2 guibg=#282a36 gui=NONE
...
hi rubyRailsMethod ctermfg=57 ctermbg=NONE cterm=NONE guifg=#8be9fd guibg=NONE gui=NONE
